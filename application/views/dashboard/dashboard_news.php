		...
		<table class="w3-table w3-table-stripped table-bordered">
			...
			<?php foreach($data as $item): ?>
				...
				<td>
					...
					<button class="btn btn-warning btn-sm" onclick="delete_('<?php echo $item->slug; ?>','<?php echo $item->title; ?>','Confirm deleting news with title ','delete_news')"><i class="fa fa-trash"></i></button></td>
				</tr>
			<?php endforeach; ?>
			</tr>
			</tbody>
	...
	<div class="modal-dialog" role="document" style="width: 60%">
		<div class="modal-content">
			...
			<div class="modal-body">
				<?php echo form_open_multipart('addNew');?>
				<div class="col-lg-7">
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<?php echo form_open_multipart('edit_news');?>
				<div class="row">
					<div class="col-lg-6">
