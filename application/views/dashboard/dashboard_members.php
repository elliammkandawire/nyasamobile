	...
	<div id="container" style="width: 100%;" class="jumbotron">
		...
		<table class="w3-table w3-table-stripped table-bordered">
			...
			<?php foreach($data as $item): ?>
				...
				<td>
					<button style="margin-bottom: 5px" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit" data-whatever="@mdo" onclick="edit_member('<?php echo $item->slug; ?>')"><i class="fa fa-edit"></i></button>
					<button class="btn btn-warning btn-sm" onclick="delete_('<?php echo $item->slug; ?>','<?php echo $item->name; ?>','Confirm deleting member with title ','partners/delete')"><i class="fa fa-trash"></i></button></td>
				</tr>
			<?php endforeach; ?>
			</tr>
			</tbody>
	...
	<div class="modal-dialog" role="document" style="width: 50%">
		<div class="modal-content">
			...
			<div class="modal-body">
				<?php echo form_open_multipart('addMember');?>
				<div class="col-lg-6">
					...
					<div class="form-group">
						...
						<select class="form-control" name="partner_group">
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<?php echo form_open_multipart('updateMember');?>
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="form-group">
							<label for="message-text" class="col-form-label">Partner Website:</label>
							<input type="text" id="website" name="website" class="form-control" required>
						</div>
						<div class="form-group">
							<label for="message-text" class="col-form-label">Category</label>
							<select class="form-control" name="partner_group" id="partner_group">
								<?php foreach ($partners as $partner): ?>
								<option value="<?php echo $partner->slug ?>"><?php echo $partner->name ?></option>
								<?php endforeach; ?>
							</select>
